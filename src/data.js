...
export const projects = [
    {
        ...
        bts: {
            stills: [
                ...
                "https://storage.googleapis.com/mohamed-portfolio-media/Ads/Kashmir%20add/bts/3A8875BA-2FE7-451A-A169-3C690E9C1C39%202.JPG",
    ...
    },
    {
        ...
        title: "Arab Cup",
        category: "Documentaries",
        brief: "Arab Cup BTS | DOHA+ — Short Film (Cinematographer / Multi-Camera Unit) \nShot a high-profile behind-the-scenes short during the Arab Cup in Doha as part of a rapidly scaling multi-camera team (2 to 6 operators across three 10-hour shoot days), maintaining a consistent visual language across all coverage. Worked handheld with anamorphic cinema lenses to build an immersive POV style, capturing dramatic BTS moments and interviews alongside Qatari director Ahmed Al-Baker and Syrian actor Rashid Assaf, in addition to notable talent such as Jeremy Irons.",
